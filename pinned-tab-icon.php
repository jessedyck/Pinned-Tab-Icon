...
Description: A WordPress Plugin that adds Customizer controls (in the Site Icon section) to select an SVG image file and set the colour, for use in Safari 9's Pinned Tab feature. See https://support.apple.com/kb/PH21462?locale=en_US for details from Apple.
Author: Jesse Dyck
Version: 1.1
...
function jd_pinned_icon_customizer ($wp_customize)
{
	// Image field
	$wp_customize->add_setting( 'jd_pinned_icon_image', array(
	    'default'        => '',
	    'type'           => 'option',
	...
	$wp_customize->add_control( 
		new WP_Customize_Media_Control( $wp_customize, 'jd_pinned_icon_control', array(
	...
	// Colour field
	$wp_customize->add_setting( 'jd_pinned_icon_colour', array(
	    'default'        => '#000000',
	    'type'           => 'option',
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control( $wp_customize, 'jd_pinned_icon_color_control', array(
		  'label' => 'Pinned Tab Image Color',
		  'description' => 'Define the colour for the image',
		  'section' => 'title_tagline',
		  'settings' => 'jd_pinned_icon_colour',
		  'priority' => 100
		) 
	) );
}
add_action( 'customize_register', 'jd_pinned_icon_customizer' );
...
function jd_pinned_icon_output ()
{
	$img_id = get_option( 'jd_pinned_icon_image' );
	...
	$colour = get_option ( 'jd_pinned_icon_colour' );
...
add_action ( 'wp_head', 'jd_pinned_icon_output' );
